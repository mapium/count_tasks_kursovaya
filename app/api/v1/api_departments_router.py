...
@router.post("/departments", tags=["departments"], description="Только с правами администратора")
...
@router.put("/departments/{id}", tags=["departments"], description="Только с правами администратора")
...
@router.delete("/departments/{id}", tags=["departments"], description="Только с правами администратора")
