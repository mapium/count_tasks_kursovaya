...
app_v1 = FastAPI(title="API по учёту производственных задач", lifespan=on_startup, description="Приложение содержит информацию о контингенте сотрудников предприятия и распределению их по подразделениям, а также проводит учёт производственных задач.", version="1.0.0")
